...
export class RolPermisoController {
  ...
  async find(
    ...
    return this.rolRepository.tiene_partidos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.rolRepository.tiene_partidos(id).create(permiso);
  }
  ...
  async patch(
    ...
    return this.rolRepository.tiene_partidos(id).patch(permiso, where);
  }
  ...
  async delete(
    ...
    return this.rolRepository.tiene_partidos(id).delete(where);
  }
}
